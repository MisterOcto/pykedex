...
urlpatterns = [
    ...
    ('pokeapi/get/one/<str:name>', p_views.get_pokemon_from_pokeapi_by_name),
    ('pokeapi/get/one/<int:id>', p_views.get_pokemon_from_pokeapi_by_id),
    ('pokeapi/get/some/<int:limit>/<int:offset>', p_views.get_some_pokemon_from_pokeapi),
    ('pokeapi/get/some/<str:name>', p_views.get_some_pokemon_from_pokeapi_by_letters),
    ('pokeapi/get/all', p_views.get_all_pokemon_from_pokeapi),
